...
# Load the regression-specific encoders and scaler
...
exited = st.selectbox('Has the customer churned? (Exited)', [0, 1])
...
# Scale the input data using the regression scaler
